...
MD="$DIR/CSW-ACI-Integration-Guide.md"
HTML="$DIR/CSW-ACI-Integration-Guide.html"
PDF="$DIR/CSW-ACI-Integration-Guide.pdf"
...
echo "$CSS" | pandoc "$MD" \
  --standalone \
  --embed-resources \
  --metadata title="Cisco Secure Workload — Cisco ACI Integration Guide" \
  --css /dev/stdin \
  -o "$HTML"
